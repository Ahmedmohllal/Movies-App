...
public class TopRatedFragment extends Fragment implements MovieRecyclerClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.top_rated_rec);
    ...
    private void getData(){
        ...
        movieViewModel.getRatedMutableData().observe(getActivity(), new Observer<ArrayList<MovieModel>>() {
            @Override
