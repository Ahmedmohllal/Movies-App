...
public class IncomingFragment extends Fragment implements MovieRecyclerClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.incoming_rec);
    ...
    private void getData() {
        ...
        movieViewModel.getUpcomingMutableData().observe(getActivity(), new Observer<ArrayList<MovieModel>>() {
            @Override
